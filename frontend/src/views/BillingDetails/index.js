...
const BillingDetails = () => {
  ...
  const addresses = [
    "5521 Charles Street, Halifax, NS, B3K 1J1",
    "1204 Barrington Street, Halifax, NS, B3K 1L1",
    "Other",
  ];
  const [phones, setPhones] = useState(["9876543210", "1234567890", "Other"]);
    ...
    return (
      <>
        <Container maxWidth="sm">
          <Typography
            style={{ fontWeight: 100, fontSize: "14px", marginBottom: "7%" }}
          >
            Provide your contact details where we could contact you regarding
          ...
          <Grid container>
            <Grid item xs={12}>
              <FormControl fullWidth>
                <InputLabel style={{ color: "white" }}>Select email</InputLabel>
                <Select
                  label="Select email"
                  value={selectedEmail}
  ...
  const AddressDetailsStep = ({ onBack }) => {
    ...
    const handleNext = () => {
      ...
      const params = {
        amount: "$256", //todo: need to receive from cart
        phone: custPhone,
        email: custEmail,
      ...
      <>
        <Container maxWidth="sm">
          <Typography
            style={{ fontWeight: 100, fontSize: "14px", marginBottom: "7%" }}
          >
            Provide your shipping address where we you would like your order to
