...
import logo from "../../assets/images/Home/coblogo.png"
    ...
    <FooterContainer>
      <FooterGridContainer container spacing={4}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          <FooterLink href="#">Men's</FooterLink>
          <FooterLink href="#">Women's</FooterLink>
          <FooterLink href="#">Kids'</FooterLink>
          {/* <FooterLink href="#">Sale</FooterLink> */}
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <FooterTitle variant="h6">About</FooterTitle>
          <FooterLink href="#">About Cobblr</FooterLink>
